  ...
  <nav id="menu">
          ...
          <label id="toggle-nav-label" for="toggle-nav"><i class="icon-reorder"></i>Search Data</label>
...
<li class='horizontal'><form action='registration.php' method='POST'> 
 <input type='hidden' name='close' value='".$close."'>
<input type='submit' class='user' name='register' value='Play' id='submit' /></form>
</li>
<li class='horizontal'>
...
echo" <nav id='menu' style='background:#fff'>
  
        
          <input type='checkbox' id='toggle-nav'/>
          <label id='toggle-nav-label' for='toggle-nav'><i class='icon-reorder'></i>Navigation</label>
...
<input class='sign-in' type='text'  id='team_name' name='team_name' placeholder='Team name' /></li>
<li class='horizontal'>
<input class='sign-in' type='password'  id='password' name='password' placeholder='Password' /></li>
<li class='horizontal'>
<input  type='submit'  name='submit' value='Log in' id='submit' /></form></li>
<li class='horizontal'>
...
<li class='horizontal'><form action='phone_metadata.php' method='POST'>
  <input type='hidden' name='team_name' value='".$team."'>
  <input type='hidden' name='passsword' value='".$password."'>
  <input  type='submit' name='submit' value='Phone' id='submit' /></submit>  </form></li>

<li class='horizontal'><form action='email_metadata.php' method='POST'>
    <input type='hidden' name='close' value='".$close."'>
    <input type='hidden' name='team_name' value='".$team."'>
    <input type='hidden' name='password' value='".$password."'>
