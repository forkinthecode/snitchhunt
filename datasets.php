...
echo"<table class='basic' border='0' ><tbody>
  <tr><td >Subscriber <a href='https://en.wikipedia.org/wiki/International_Mobile_Station_Equipment_Identity' target='_blank'>IMEI</a>:</td><td> ".$row['subscriber_imei']."</td></tr>
